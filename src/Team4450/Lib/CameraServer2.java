...
public class CameraServer2 
{
  ...
  private CameraServer2() 
  {
    ...
    Util.consoleLog("4450 Usb Camera M-JPEG stream Server");
   ...
   */
  public synchronized void startAutomaticCapture(String cameraName) 
  {
    try 
    {
   ...
   * vision processing on the roboRIO. {@link #setImage} shouldn't be called after this is called.
   *
   * @param camera USBCamera object to capture images from.
   */
  ...
  protected void capture() 
  {
    ...
    while (true) 
    {
      ...
      synchronized (this) 
      {
        ...
        if (hwClient) dataBuffer = m_imageDataPool.removeLast();
      }
